...
public class FurnitureModel implements Parcelable {
    ...
    public FurnitureModel(long id, String category, String title, String price,
                          String description, String discount, byte[] image) {
        this.id = id;
    ...
    public FurnitureModel(String category, String title, String price, String description,
                          String discount, int imageInt) {
        this.category = category;
        this.title = title;
        this.price = price;
        this.description = description;
    ...
    public FurnitureModel(String category, String title, String price,
                          String description, int imageInt) {
        this.category = category;
        this.title = title;
        this.price = price;
        this.description = description;
